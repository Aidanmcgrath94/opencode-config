...
When invoked with a file or image already attached to your context, analyze the attachment directly. Never call tools, never spawn other agents, and never try to load the file by path.
